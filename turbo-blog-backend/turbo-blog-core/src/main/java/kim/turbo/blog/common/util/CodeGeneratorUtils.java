package kim.turbo.blog.common.util;
...
public class CodeGeneratorUtils {
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("kim.turbo.blog.manage");
        ...
        InjectionConfig cfg = new InjectionConfig() {
            ...
            public void initMap() {
                ...
                map.put("basePath","kim.turbo.blog");
                this.setMap(map);
            }
        };
        ...
        strategy.setSuperControllerClass("kim.turbo.blog.manage.sys.controller.AbstractController");
