    ...
    <transition name="slide-fade">
      <div id="header" v-show="show">
        <router-link id="logo" to="/">
          <img src="../../../assets/20201217144206.jpg">
          <span class="title">Turbo's Blog</span>
          <span class="motto">ᴬˡʷᵃʸˢ ʰᵃᵖᵖʸ ᵃⁿᵈ ᵒᶜᶜᵃˢⁱᵒⁿᵃˡˡʸ ˡᵒˢᵉ ⁱⁿᵗᵉʳᵉˢᵗ ⁱⁿ ᵉᵛᵉʳʸᵗʰⁱⁿᵍ.</span>
        </router-link>
        <ul id="nav">
          <li>
      ...
      <span class="algolia-autocomplete" style="position: relative; display: inline-block; direction: ltr;">
        <input
          type="text" id="search-query-nav" class="search-query st-default-search-input aa-input" name="keywords"
          v-model="keywords" @keyup.enter="submit"
        ...
        <span
          ...
          <li><a href="/articles" class="nav-link contribute">首页</a></li>
